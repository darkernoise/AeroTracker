...
class AT_ListenerConnection(object):
    ...
    def __init__(self, cluster_id, target_id, listener_name, address, port, log):
...
#     _rate_cnt = 0
    ...
    def __init__(self, dir_store, cluster_id, target_id, params, log):
        '''
        Constructor
        '''
    ...
    def _add_listner_reg(self, lstnr):
        ...
        con = AT_ListenerConnection(cluster_id=self._cluster_id, 
