...
class GTK_Plot_Tester(object):
    '''
    Test that GTK plotting is working on the local client.
    
    All code on this from: http://gtk3-matplotlib-cookbook.readthedocs.io/en/latest/hello-plot.html
    '''
